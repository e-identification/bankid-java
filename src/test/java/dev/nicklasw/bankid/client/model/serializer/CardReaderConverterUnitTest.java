...
class CardReaderConverterUnitTest extends UnitTest {

    private final CardReaderConverter converter = new CardReaderConverter();
    ...
    void serialize(final CardReader cardReader, final String expectedCode) {
